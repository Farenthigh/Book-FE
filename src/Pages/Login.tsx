      ...
      <div className="bg-white shadow-lg rounded-lg">
        <div>
          <div className="flex justify-end p-5">
            {/* เพิ่ม onClick เพื่อเรียก handleClose */}
            <img
              src={close}
              alt="close"
        ...
        <div className="flex justify-center w-full">
          <div className="flex flex-col items-center w-1/3 p-2 gap-5">
            ...
            ></input>
            <h4 className="text-sm text-gray-600 hover:underline transition-colors duration-200 ml-72">
              Forget password?
            </h4>
            <input
            ...
            <div className="flex gap-1">
              ...
              <Link to={SIGNUP_ROUTE}>
                <div className="flex justify-start text-sub gap-5 text-purple-400 hover:underline transition-colors duration-200 mb-10">
                  Register
                </div>
              </Link>
            </div>
